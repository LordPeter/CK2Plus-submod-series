...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 0.10,	-- Extra Max Demesne Size from ruler and spouse stewardship
	...
	CROWN_LAW_REVOLTRISK_INCREMENT = 0,		-- Revoltrisk reduction/decrease due to crown laws
	...
	DEMAND_RELIGIOUS_CONVERSION_INTERACTION_PIETY = 10,
	...
	ASK_FOR_EXCOMMUNICATION_INTERACTION_PIETY = 200,
	ASK_FOR_EXCOMMUNICATION_INTERACTION_PRESTIGE = 0,
	ASK_FOR_EXCOMMUNICATION_INTERACTION_THRESHOLD_FOR_NO = 75,
	...
	ASK_TO_LIFT_EXCOMMUNICATION_INTERACTION_PIETY = 100,
...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_40 = 0,				-- Natural deaths per decade out of 10000 people: Age 40-49
...
-- Monthly prestige from vassals
	BARON_AS_VASSAL_PRESTIGE = 0.005,
...
NReligion = {
	...
	AUTHORITY_FROM_ANTIPOPE = 0.0,					-- Authority from each antipope
...
NEconomy = {
	...
	REPUBLIC_CAPITAL_CITY_TAX_BONUS = 0.1,			-- Duke or above tier Republics receive a tax bonus for their capital city
	BISHOP_TAX_TO_POPE_FACTOR = 0.05,				-- Bishops only pay half the tax to the Pope if they are loyal to him
	...
	MIN_TRADE_POSTS = 3,							-- Minimum number of max trade posts per patrician	
	...
	OVER_MAX_DEMESNE_TAX_PENALTY = 0.33,			-- Percent penalty per county over the limit
	TAX_TO_LOOT_MULTIPLIER = 0.5,					-- Lootable gold per tax 
	FORT_LOOT_DEFENCE_MULTIPLIER = 1.0,				-- Loot protected gold per fortlevel
	LOOTABLE_GOLD_REGROWTH = 0.01,					-- Percent of max lootable gold that regrows every month
	...
	LOOT_EVERY_X_DAYS = 8,							-- Loot every this many days
...
NMilitary = {
	...
	VASSAL_MERC_HIRE_COST_FACTOR = 0.5,				-- Fraction of nominal hire cost when hiring vassal mercenaries or holy orders
	...
	SIEGE_MORALE_LOSS = 0.4,						-- Monthly morale loss in a siege
	...
	CONTESTED_TERRITORY_WARSCORE_MULTIPLIER = 1.25,	-- Multiplier for contested settlements
	...
	NAVAL_ATTRITION = 0.02,							-- Attrition taken monthly by units loaded on ships
	...
	LOW_DECADENCE_MORALE_MOD = 0.25,				-- Extra Morale defence when at 0% decadence
	HIGH_DECADENCE_MORALE_MOD = 1.5,				-- Extra Morale damage taken when at 100% decadence
	...
	LIEGE_LEVY_SIZE_MULTIPLIER = 1.0,				-- The Size of the liege levy will be the total troops in the vassal subrealm * this
